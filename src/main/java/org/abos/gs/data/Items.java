...
public interface Items {
    ...
    ItemLike CARROT = new Item("carrot", 19);
    ...
    ItemLike DANDELION_ROOT = new Item("dandelion_root", 17);
    ...
    ItemLike DIRT = new Item("dirt", 10);
    ...
    ItemLike SMALL_FOSSIL = new Item("small_fossil", 50);
    ...
    ItemLike STONE_SHOVEL = new Item("stone_shovel", 8);
