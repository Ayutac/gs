...
public interface Items {
    ...
    ItemLike BOLET = new Item("bolet", 5);
    ItemLike BLACKBERRY = new Item("blackberry", 4);
    ItemLike BONE = new Item("bone", 10);
    ItemLike BOW_DRILL = new Item("bow_drill", 8);
    ItemLike BRANCH = new Item("branch", 2);
    ...
    ItemLike DEER_SNARE = new Item("deer_snare", 12);
    ItemLike DEER_CARCASS = new Item("deer_carcass", 15);
    ItemLike DEER_HIDE = new Item("deer_hide", 16);
    ItemLike DEER_SKULL = new Item("deer_skull", 18);
    ItemLike DRIED_LEAF = new Item("dried_leaf", 1);
    ItemLike DRIED_MOSS = new Item("dried_moss", 5);
    ItemLike DRIED_SINEW = new Item("dried_sinew", 13);
    ItemLike DRYADS_SADDLE = new Item("dryads_saddle", 5);
    ...
    ItemLike PINENUT = new Item("pinenut", 5);
    ItemLike PLANT_ROPE = new Item("plant_rope", 4);
    ...
    ItemLike WALNUT = new Item("walnut", 5);
    ItemLike WOODEN_BOARD = new Item("wooden_board", 9);
    ItemLike WOODEN_BOWL = new Item("wooden_bowl", 9);
    ItemLike WOODEN_ROD = new Item("wooden_rod", 4);
    ItemLike WOODEN_TOKEN = new Item("wooden_token", 5);
    ItemLike YOUNG_LOG = new Item("young_log", 6);
