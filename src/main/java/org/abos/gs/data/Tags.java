...
public interface Tags {
    ...
    TagLike KNIVES = new Tag("knives", Set.of(Items.STONE_KNIFE));
    TagLike LOGS = new Tag("logs", Set.of(Items.OLD_LOG, Items.STRIPPED_OLD_LOG, Items.STRIPPED_YOUNG_LOG, Items.YOUNG_LOG));
